  ...
  return (
    <div className="space-y-6">
      <div className="mb-2">
        ...
        <p className="text-sm text-muted-foreground">Ikhtisar hafalan dan setoran santri.</p>
      </div>
        ...
        <Card className="border-border/30 shadow-sm hover:shadow-md transition-shadow">
          <CardContent className="p-5 flex items-center gap-4">
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold text-foreground">{state.submissions.length}</h3>
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="border-border/30 shadow-sm">
        <div className="p-5 border-b border-border/50 flex items-center gap-2">
          ...
          <h3 className="text-lg font-semibold text-foreground">Peringkat Hafalan</h3>
        </div>
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-baseline justify-between gap-2">
                      <div className="truncate text-[15px] font-semibold text-foreground">
                        {s.nama}
                        {s.kelas && (
                          <span className="ml-2 text-[13px] font-normal text-muted-foreground">({s.kelas})</span>
                        )}
                      </div>
                    </div>
