...
export default function KelompokLoading() {
  return (
            ...
            <table className="w-full border-collapse text-left">
              <thead>
                <tr className="border-b border-border/50 bg-card/50">
                  ...
                  <th className="py-3.5 px-4"><div className="h-4 w-20 rounded bg-border/60" /></th>
              ...
              <tbody className="divide-y divide-border/30">
                {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
                  <tr key={i} className="hover:bg-card/30">
                    ...
                    <td className="py-3.5 px-4"><div className="h-4 w-24 rounded bg-border/40" /></td>
